...
module Rack
  class MiniProfiler
    ...
    class SparqlTimerStruct < TimerStruct
      def initialize(query, duration_query_ms, size_response, parse_response_ms,
                     page, parent, skip_backtrace = false, full_backtrace = false)
        ...
        super("ExecuteType" => 3, # TODO
              ...
              "StartMilliseconds" => ((Time.now.to_f * 1000).to_i - page['Started']) - duration_query_ms,
              "DurationMilliseconds" => duration_query_ms,
              "ParseMilliseconds" => parse_response_ms,
              "SizeResponseKB" => size_response,
              "FirstFetchDurationMilliseconds" => duration_query_ms,
              "Parameters" => nil,
              "ParentTimingId" => nil,
              "IsDuplicate" => false)
      end
